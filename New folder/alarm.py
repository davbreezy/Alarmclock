...
def desactivate_alarm():
    print('Desactivate alarm: ',selected.get())
    mixer.music.stop()
...
rad2 = Radiobutton(frame_body, font=('arial 10 bold'), value = 2, text = "desactivate", bg=bg_color,command=desactivate_alarm, variable=selected)
